...
public ResultSet when_cross_join2(String temporal_table,String table,Map<String,String> m1, Map<String,String> m2){
	...
	public ResultSet non_temporal_natural_join(String tbl1,String tbl2,String col1,String col2){
		...
		sql_query+=" from "+tbl1+" , "+tbl2+" where "+tbl1+"."+col1+"="+tbl2+"."+col2;
		//System.out.println(sql_query);
		try {
			stmt = db.get_connection().prepareStatement(sql_query);
			ans = stmt.executeQuery(); 
	...
	public ResultSet History_Natural_join2(String table , String temporal_table){
	...
	public ResultSet At_Natural_join2(String table , String temporal_table, String date) {
		...
		for (Map.Entry<String,String> e: pk.entrySet()) {
			if (first) {
				first = false;
				sql_query += table+"." + e.getKey() + "=t1." + e.getKey();
			} else {
